...
/**
 * @Description 签发量统计（签发到人）  ------ 停用
 * @Author WangXueDong
 * @Date 2020/12/17 17:24
 * @Version 1.0
 **/
public class SignAmountCountPersonStream {

    private static final Logger logger = LoggerFactory.getLogger(SignAmountCountPersonStream.class);
    private static final String ClassName = SignAmountCountPersonStream.class.getSimpleName();
    private static final long STREAM_CHECKPOINT_INTERVAL = 60000;
    private static final CheckpointingMode STREAM_CHECKPOINT_MODE = CheckpointingMode.EXACTLY_ONCE;
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<JsonLogInfo> filterRes = data.filter((FilterFunction<JsonLogInfo>) jsonLogInfo -> {
            if (null != jsonLogInfo) {
                ...
                if (CONSTANTS.EVENT_ESSC_LOG2_SIGN_PERSON.equals(event)) {
